...
//if (isset($_POST['posttab'])) {
 ...
 $private    = 'PRIVATE';
    ...
    if(isset($_POST['tab1']) && $_POST['tab1'] != ''){
$drug_tab1 = $_POST['tab1'];
$d = $drug_tab1;
    ...
    $tab1 = $object->get_drug($d)['itemname'];
    ...
    //$sales = $con_ar[5];
    //$object->put_spent($prn);
    //$qty1 = number_format($_POST['qty1']);
        
    $route1 = $_POST['route1'];
    $dur1 = $_POST['dur1'];
    $freq1 = $_POST['freq1'];
    $physio_instruct1 = $_POST['physio_instruct1'];
    $dosage1 = $_POST['dosage1'];

    $qty1 = number_format($_POST['dosage1'] * $_POST['freq1'] * $_POST['dur1']);
    ...
    if($object->get_ivf_file($prn_drug)['donor'] == 'donor'){
        ...
        $source1 = $object->Create_tab1($tab1, $dosage1, $freq1, $dur1, $qty1,$physio_instruct1, $prn_drug,$pt_time,
    $pt_date,$route1,$drug_group_id,$drug_id,$cost,$sales,$totamt1,$d_sg_id,$staffname,$ivfno,$status,$payment_status,$sponsorid,$bcode,$ccode,$qty_dis,$pres_bal1,$qty_ind1,$ind_bal1,$age,$pat_cat,$pat_type,$ipno,$post_status,$vsn);

    // $object->Create_tab1($tab1,$drug_group_id,$d_sg_id,$drug_id,$cost,$sales,$prn_drug,$pt_date,$pt_time,$staffname,$ivfno,$status,
    //$qty1,$physio_instruct_tab1,$payment_status,$sponsorid,$bcode,$ccode,$totamt1,$pres_bal1,$qty_ind1,$ind_bal1,$qty_dis,$age,$pat_cat);
...
if(isset($_POST['tab2']) && $_POST['tab2'] != ''){

    $drug_tab2 = $_POST['tab2'];
    $d = $drug_tab2;
    

    $tab2 = $object->get_drug($d)['itemname'];
    ...
    $dur2 = $_POST['dur2'];
    $freq2 = $_POST['freq2'];
    $physio_instruct2 = $_POST['physio_instruct2'];
    $dosage2 = $_POST['dosage2'];

    $qty2 = number_format($_POST['dosage2'] * $_POST['freq2'] * $_POST['dur2']);
    ...
    if($object->get_ivf_file($prn_drug)['donor'] == 'donor'){
        $source2 = $object->Create_tab2($tab2, $dosage2, $freq2, $dur2, $qty2,$physio_instruct2, $prn_drug,$pt_time,
    $pt_date,$route2,$drug_group_id2,$drug_id2,$cost2,$sales2,$totamt2,$d_sg_id2,$staffname,$ivfno,$status,$payment_status,$sponsorid,$bcode,$ccode,$qty_dis,$pres_bal2,$qty_ind2,$ind_bal2,$age,$pat_cat,$pat_type,$ipno,$post_status,$vsn);
    if ($object->get_cat($category)['category'] == $family){
        $post_status = 'Y';
