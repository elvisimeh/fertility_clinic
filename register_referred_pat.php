...
$ccode = $_SESSION["companycode"];  
 ...
 $visit_details = $ivfobj->referred_pat_details($prn);
...
<li><a onclick="referral_list()">Patients Referred By Doctor</a></li>
...
<div class="col-md-3" style="">
<?php echo $visit_details['staffname']; ?>
</div>
<div class="col-md-1">
DOB:
</div>
...
<div class="container">
<div class="panel panel-default rounded" style="border-width: 0px 1px 2px 1px; border-color:#B0E0E6">

<div class="panel-body bg-info" style="">

<div class="row" style="display:block; margin:auto">
<div class="col-md-12">
<label for="">Reason For Referral</label>
<textarea class="form-control" name="" id="" cols="30" rows="5" readonly><?php echo $visit_details['patient_complaint']; ?></textarea>
</div>
</div>
...
<input type="hidden" value="<?php echo $visit_details['vsn'] ?>" name="" id="vsn">
<input type="hidden" value="0" name="" id="donor">
<input type="hidden" value="ref" name="" id="referral">
