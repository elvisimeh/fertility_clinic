...
<h4 class="modal-title" style="text-align:center">Add Laboratory Investigations</h4>
...
<input type="hidden" name="category" value="<?php echo $patient_details['cat']; ?>" id="category">
