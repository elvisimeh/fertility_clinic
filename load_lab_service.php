...
$lab = 'LABORATORY';
//if($ivfno===null){
$load_services = $ivfobj->load_service_prn($prn,$lab);
/*}
else{
...
<?php
      ...
      foreach($load_services as $load_service){
          if($load_service['unitname'] == 'LABORATORY'){ ?>
...
<tr>
    ...
    <td>
    &#8358;<?php echo $load_service['agreed_amt'] ?>
    </td>
    <td>
    ...
    <span onclick="delete_service(this)" id=<?php echo $load_service['id'] ?> data-prn="<?php echo $prn ?>" style="color:#D9534F; font-weight:bold;cursor:pointer;" class="glyphicon glyphicon-remove-circle"></span>&nbsp;
    <?php } 
    else { ?>
    <a onclick="load_inv_result(<?php echo $load_service['id']?>)" href="lab_result?id=<?php echo $load_service['id'] ?>" class="btn btn-success" data-target="#lab_results" data-toggle="modal">View result</a>
   <?php }
    ?>
</td>
</tr>
